...
mod tests {
    ...
    fn test_response_struct_creation_200() {
        let response_actual = HttpResponse::new("200", None, Some("Item was shipped".into()));
    ...
    fn test_response_struct_creation_400() {
        let response_actual = HttpResponse::new("404", None, Some("item not found".into()));
        ...
        let response_expected = HttpResponse {
            ...
            body: Some("item not found".into()),
        };
        assert_eq!(response_actual, response_expected)
    }
    #[test]
    fn well_formed_http_response() {
        let response_actual = "HTTP/1.1 404 Not Found \r\nContent-type:text/html\r\nContent-Length: 33\r\n\r\nItem was shipped on 21st Dec 2020";
        let responce_expected = HttpResponse::new(
            "404",
            None,
            Some("Item was shipped on 21st Dec 2020".into()),
        );
        let string_res: String = responce_expected.into();
        assert_eq!(string_res, response_actual)
    }
}
